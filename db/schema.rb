...
ActiveRecord::Schema.define(version: 20160809022032) do
  ...
  create_table "goshippoids", force: :cascade do |t|
  ...
  add_index "spree_orders", ["is_pos"], name: "index_spree_orders_on_is_pos"
  ...
  create_table "spree_stores", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                    null: false
    t.datetime "updated_at",                                                    null: false
    t.string   "goshippo_api"
    t.string   "publishable_api"
    t.string   "goshippo_base_api_url", default: "https://api.goshippo.com/v1"
  end
